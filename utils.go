...
var (
	// ErrUnsupportedDatabase returned if database dialect is unsupported
...
// NewConnectionManager return a ConnectionManager implementation for the provided connection string.  Will return
...
func NewConnectionManager(connStr string, debugMode bool, defaultDB ...string) (ConnectionManager, error) {
	defaultLoggerConfig := logger.New(
